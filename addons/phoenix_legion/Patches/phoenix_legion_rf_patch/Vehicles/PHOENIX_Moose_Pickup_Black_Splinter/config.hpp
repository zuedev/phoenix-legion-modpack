class CfgVehicles {
    class PHOENIX_Moose_Pickup_BASE;

    class PHOENIX_Moose_Pickup_Black_Splinter: PHOENIX_Moose_Pickup_BASE {
        scope = public;
        displayName = "Moose Pickup (Black Splinter)";
        hiddenSelectionsTextures[] = {
            "\z\phoenix_legion_modpack\addons\phoenix_legion_modpack_phoenix_legion\Patches\phoenix_legion_rf_patch\Vehicles\PHOENIX_Moose_Pickup_Black_Splinter\pickup_01_ext_ldf_co_PHOENIX.paa",
            ...
            "\z\phoenix_legion_modpack\addons\phoenix_legion_modpack_phoenix_legion\Patches\phoenix_legion_rf_patch\Vehicles\PHOENIX_Moose_Pickup_Black_Splinter\pickup_01_service_ldf_co_PHOENIX.paa"
        };
    };
};