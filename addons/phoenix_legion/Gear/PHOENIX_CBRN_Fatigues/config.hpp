class CfgWeapons {
    ...
    class PHOENIX_CBRN_Fatigues: PHOENIX_CBRN_Fatigues_PARENTPROXY {
        ...
        hiddenSelectionsTextures[] = {"\z\phoenix_legion_modpack\addons\phoenix_legion\Gear\PHOENIX_CBRN_Fatigues\CBRN_Suit_01_EAF_CO_PHOENIX.paa"};
        picture = "\z\phoenix_legion_modpack\addons\phoenix_legion\Gear\PHOENIX_CBRN_Fatigues\icon_U_I_E_CBRN_Suit_01_EAF_F_ca_PHOENIX.paa";
